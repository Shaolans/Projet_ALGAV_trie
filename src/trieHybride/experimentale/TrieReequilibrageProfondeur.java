...
public class TrieReequilibrageProfondeur {
	...
	public static void main(String[] args) {
		...
		for(int i = 0; i < max; i++){
			...
			if(i%pas == 0){
				...
				depth.add(i+" "+TrieHybridePrimitive.profondeurMoyenne(root));
			}
		}
		
		
		TriePrintFile.printFile("comparaison/trie_hybride_reequilibrage_profondeur_moyenne.txt", depth);
